...
\begin{tikzpicture}[
    ...
    \begin{scope}[shift={(10,0)}]
      ...
      \node[align=center] at (6, 1) {热沉\\$T_{\text{环境}}$};
      
      % Temperature difference arrow
      \draw[<->, thick, red] (1.0, 1.7) -- (6.0, 1.7) node[midway, above] {$\Delta T = T_{\text{结}} - T_{\text{环境}}$};
    ...
    \begin{scope}[shift={(0,-2)}]
      ...
      \node[anchor=west, font=\small] at (-0.3, -0.5) {
        \begin{tabular}{ll@{\hspace{2em}}ll}
          ...
          \hline
          电压$V$ & 温差$\Delta T$ & 伏特 与 开尔文 \\
          电流$I$ & 热流$P$ & 安培 与 瓦特 \\
          电阻$R$ & 热阻$R_{\mathrm{th}}$ & 欧姆 与 开尔文每瓦 \\
          电导率$\sigma$ & 热导率$\kappa$ & 西门子每米 与 瓦特每米每开尔文 \\
          电容$C$ & 热容$C_{\mathrm{th}}$ & 法拉 与 焦耳每开尔文 \\
        \end{tabular}
      };
      ...
      \node[anchor=west, font=\small] at (9, -2.4) {
        \textbf{典型值参考:} 砷化镓 $\kappa \approx 46\,\mathrm{W/(m\cdot K)}$，磷化铟 $\kappa \approx 68\,\mathrm{W/(m\cdot K)}$
      };
    \end{scope}
    ...
    \begin{scope}[shift={(0,-5)}]
      ...
      \node[anchor=west, font=\small] at (-0.3, -0.2) {
        \textbf{光子晶体面发射激光器中的应用示例}: 假设有源区功耗$P_{\mathrm{heat}} = 0.5\,\mathrm{W}$，外延层总热阻$R_{\mathrm{th}} = 80\,\mathrm{K/W}$，则温升
      };
      ...
      \node[anchor=west, font=\small] at (-0.3, -1.5) {
        这意味着结温比热沉温度高$40^\circ\mathrm{C}$。若环境温度$25^\circ\mathrm{C}$，则结温达$65^\circ\mathrm{C}$，需要考虑温度对增益和折射率的影响。
      };
    \end{scope}
