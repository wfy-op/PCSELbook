...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[x=1cm,y=1cm,>=Latex]
    \fill[blue!6] (0,0) circle (1.45);
    \draw[->] (-3.1,0)--(3.1,0) node[right]{$k_x$};
    \draw[->] (0,-2.2)--(0,2.6) node[above]{$k_y$};
    \draw[thick,blue!55!black] (0,0) circle (1.45);
    \node[blue!55!black] at (0,1.78){光锥/辐射连续谱};
    \fill[blue!75] (2.35,0.82) circle (0.08) node[above right=1pt]{$\kvec_{\parallel}$};
    \fill[red!75] (0.95,0.82) circle (0.08) node[above left=1pt]{$\kvec_{\parallel}-\gvec$};
    \draw[->,very thick,orange!90!black] (2.35,0.82)--node[above,sloped]{$-\gvec$}(0.95,0.82);
    \draw[dashed,gray!70] (0.95,0.82)--(0.95,0);
    \draw[dashed,gray!70] (2.35,0.82)--(2.35,0);
    \draw[->,thick,teal!70!black] (0.95,0.82)--(0.95,1.72);
    \draw[->,thick,teal!70!black] (0.95,0.82)--(0.95,-1.72);
    \node[teal!70!black,right] at (0.95,1.72){上出光通道};
    \node[teal!70!black,right] at (0.95,-1.72){下出光通道};
    \node[align=center,anchor=west] at (1.65,-1.25) {原始导模分量在光锥外\\周期散射后折叠进光锥内};
  \end{tikzpicture}
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[x=1.08cm,y=1.08cm]
    ...
    \fill[blue!6] (0,0)--(4.35,3.25)--(0,3.25)--cycle;
    \draw[thick,gray!80] (0,0)--(4.35,3.25) node[above right]{光锥边界};
    \draw[thick,blue!75] plot[smooth] coordinates {(0.45,2.05) (1.2,2.22) (2.05,2.55) (2.9,3.0) (3.7,3.48)};
    \draw[thick,red!75,densely dashed] plot[smooth] coordinates {(0.55,3.48) (1.05,3.22) (1.55,2.94) (2.05,2.66) (2.55,2.42)};
    \draw[dashed,gray!70] (3.05,0)--(3.05,3.25);
    \draw[dashed,gray!70] (1.55,0)--(1.55,3.25);
    \draw[->,very thick,orange!90!black] (3.05,3.12)--node[above]{$-\gvec$}(1.55,2.87);
    \fill[blue!75] (3.05,3.12) circle (0.05);
    \fill[red!75] (1.55,2.87) circle (0.05);
    \node[blue!75] at (3.35,2.7){原始导模色散};
    \node[red!75] at (2.75,2.05){折叠后的等效分支};
    \node[align=center] at (1.2,0.55){进入光锥后\\可泄漏到自由空间};
  \end{tikzpicture}
...
\end{equation}
这里 $\mathbf{K}$ 的非对角元代表不同传播方向之间的散射耦合，$\mathbf{\Gamma}$ 中则包含辐射损耗和内部损耗。\cref{fig:ch06_surface_emission_mechanisms}直观展示了三种主要的表面发射机制及其统一描述。
