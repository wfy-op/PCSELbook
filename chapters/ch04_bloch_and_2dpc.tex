...
Bloch 定理的本质不是经验性地假设“平面波乘周期函数”，而是利用平移对称性把无限系统的解空间按表示分类。
...
这一步的物理意义在于：它说明在周期结构中，物理上不等价的不是绝对波矢，而是波矢模掉倒格矢后的等价类。后面我们画能带、讨论 $\Gamma$ 点和高对称路径时，都是在这个意义下工作的。
...
这一步容易被误解为单纯的“频率对波矢作图”。实际上，能带是平面波在周期介质中相互耦合后的本征值图谱。理解这一点后，“带隙”“带折叠”“带边”和“Gamma 点简并”都可回到“哪些平面波被耦合在一起”这一问题上。
