...
\section*{建议继续阅读}
\begin{itemize}
  \item \cite{joannopoulos2008,sakoda2005} 中关于 Bloch 定理与二维光子晶体的基础章节。 建议重点关注 Bloch 定理、布里渊区与模式分类的标准表述。

  \item 读完下一章后再回看本章，通常会更容易理解 $\Gamma$ 点为何成为 PCSEL 模选择的核心位置。 建议重点关注本章输出量如何进入后续模型。
\end{itemize}
