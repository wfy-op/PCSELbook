...
\begin{itemize}
  ...
  \item \textbf{表面复合：}在刻蚀侧壁和界面处，$R_{\mathrm{surf}} = S(n p - n_i^2)$，$S$为表面复合速度
\end{itemize}
...
\begin{equation}
\left.\frac{\partial g_{\mathrm{th}}}{\partial T}\right|_{J=J_{\mathrm{th}}} \approx -\frac{1}{\Gamma_{\mathrm{opt}}}\frac{\partial g_{\mathrm{mat}}}{\partial T}\bigg|_{n=n_{\mathrm{th}}},
\end{equation}
