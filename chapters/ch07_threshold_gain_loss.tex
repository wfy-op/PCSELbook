...
这张图和本章公式可一一对上：注入侧折算对应 \cref{eq:gmod_nonuniform} 的空间非均匀项；复合侧折算对应“材料增益不是全都转化为受激增益”；模场侧折算对应 \cref{eq:gamma_opt_def} 中的约束因子；最终只剩能真正对冲 \cref{eq:threshold_g_th_final} 右端总损耗的那一部分。对工程设计而言，这比单独报告一个 $g_{\mathrm{th}}$ 数字更有诊断价值，因为它直接告诉你下一步该优先优化“注入”“重叠”还是“损耗”。
