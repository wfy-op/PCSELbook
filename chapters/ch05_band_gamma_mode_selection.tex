...
很多新手第一次做 PWEM 时，默认“图能画出来就可信”。这在 PCSEL 设计里风险很高。更稳妥的做法是先固定几何参数，只扫描平面波截断阶数 $N$，观察关键观测量是否进入平台区。这里给出一个和本书脚本一致的最小例子：正方晶格圆孔，$r/a=0.30$，$\varepsilon_b=3.4^2$，比较 $X$ 点第 2/3 带间隔
\[
