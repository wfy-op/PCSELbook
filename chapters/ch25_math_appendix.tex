...
\begin{NoteBox}[breakable]{首次阅读建议路径}
...
\end{ExampleBox}
\begin{MathematicalFoundationBox}{QNM 理论的三个核心数学问题}
...
\end{itemize}
这解释了为什么某些对称性保护的 BIC 无法向自由空间辐射——不是因为"损耗太小"，而是因为对称性从根本上禁止了这种耦合。
