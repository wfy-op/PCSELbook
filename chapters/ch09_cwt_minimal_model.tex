...
该平方关系不是经验假设，而是弱开口极限下的标准结果。设某个 dark family 在无辐射极限的右本征矢为
...
\cref{eq:finite_size_cwt_envelope} 的作用不是替代全波，而是把有限阵列边缘、吸收环、局域注入窗口与横向热分布纳入同一半解析框架。由此得到的输出不只是在无限周期下比较本征值，还包含有限阵列模式包络、边缘泄漏趋势和横向损耗通道。
